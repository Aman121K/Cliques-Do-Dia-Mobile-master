...
console.log("itemId",this.state.itemId);
    ...
    const url=`${baseURL}/offer/`+this.state.itemId;
...
.then((responseJson)=> {
  ...
  this.setState({
   ...
   min_price:responseJson.data.min_price.toString(),
   max_price:responseJson.data.max_price.toString(),
   amenitiesItems:responseJson.data.amenities,
   total_allowed_coupon:responseJson.data.total_allowed_coupon.toString(),
   users_coupon_per_day:responseJson.data.users_coupon_per_day.toString(),
...
// }
    ...
    )
    {
      ...
      debugger;
      const updateurl=`${baseURL}/user/update-ad/${this.state.itemId}`;
      fetch(updateurl,
      {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          min_price:parseInt(this.state.min_price),
          max_price:parseInt(this.state.max_price),
          amenities:this.state.Selectedamenities.toString(),
          total_allowed_coupon:parseInt(this.state.total_allowed_coupon),
          users_coupon_per_day:parseInt(this.state.users_coupon_per_day),
